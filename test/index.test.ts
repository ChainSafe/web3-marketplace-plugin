...
import { marketplaceContractAddressB3Sepolia, marketplaceABI } from '../src/marketplaceContract';
...
describe("Web3MarketplacePlugin Tests", () => {
  ...
  describe("TemplatePlugin method tests", () => {
    ...
    it("should call marketplaceContract and list item", () => {
      const contract = new web3.eth.Contract(marketplaceABI, "0x76b4c2877d277a1cb5565027c67241e93f6f52ab");
