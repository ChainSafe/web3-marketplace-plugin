...
import { marketplaceAddress, marketplaceId, collectionAddress, customProjectId, collectionId } from '../fixtures';
...
describe('Web3MarketplacePlugin method Tests', () => {
    ...
    it.skip('should list an item on the marketplace', async () => {
        ...
        const receipt = await web3.marketplace.listItem(contract,collectionAddress, "1", "1", deadline);
